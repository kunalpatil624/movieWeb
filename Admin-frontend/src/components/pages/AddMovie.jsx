...
//       const res = axios.post(`${MOVIE_API_AND_POINT}/add`, formData, {
...
//           <Input type="text" id="moviName" placeholder="Enter movie name" className="mt-2" name='moviName'/>
//         </div>
//         <div className="relative w-full">
//           <Label htmlFor="language">Language</Label>
//           <Input type="text" id="language" placeholder="Enter language" className="mt-2" name='language'/>
//         </div>
//       </div>
...
//           <Input type="text" id="trailer" placeholder="Enter trailer url" className="mt-2" name='trailer'/>
//         </div>
//         <div className="relative w-full">
...
//             <Input type="date" id="releaseDate" className="mt-2" name='releaseDate'/>
//           </div>
//           <div className="relative w-full">
//             <Label htmlFor="runtime">Runtime</Label>
//             <Input type="number" id="runtime" className="mt-2" name='runtime'/>
//           </div>
//         </div>
//         <div className="relative w-full">
...
//             </span>
//           </Label>
//           <Input type="text" id="genres" placeholder="Enter genres" name='genres' className="mt-2" />
//         </div>
//       </div>
//       <div className="mt-5">
//         <Label htmlFor="description">Your message</Label>
//         <Textarea placeholder="Type your message here." name='description' id="description" className="mt-2" />
//       </div>
...
//           <div key={index} className="flex flex-col md:flex-row gap-5 mt-3 items-center">
//             <div className="relative w-full">
