...
import { createShow, getShow, getShowById, getShowsByMovieAndDate, updateShow } from '../controllers/showController.js';
...
router.route("/movie/:movieId/:date").get(getShowsByMovieAndDate);
